# Model Card - paris_y_stockout_docks_30_xgboost

## Overview
- Use case: Predict short-term (30 min) stockout risk for docks at bikeshare stations.
- Business objective: Support proactive rebalancing before a station hits low inventory or low dock capacity.
- Owner: MLOps Team
- Date (UTC): 2026-03-24T18:44:05Z
...
- Labels: y_stockout_docks_30

## Modeling
- Model name: paris_y_stockout_docks_30_xgboost
- Algorithm: xgboost
- Primary metric: PR-AUC (validation) = 0.960
- Train PR-AUC: 0.963; Overfit gap: 0.003 (target < 0.10)
- Threshold (F-beta, beta=2.0): 0.22
  - Precision=0.783, Recall=0.953, F-beta=0.914
...
- Run ID: 0749aa7d9f85485d991262b73670c441
