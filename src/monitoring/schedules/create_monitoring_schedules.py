...
baseline_constraints = f"s3://{bucket}/monitoring/baseline/city=paris/constraints.json"
baseline_statistics = f"s3://{bucket}/monitoring/baseline/city=paris/statistics.json"
