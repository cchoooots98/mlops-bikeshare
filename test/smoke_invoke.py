...
def main():
    ...
    # One realistic, all-numeric row in the same order as FEATURE_COLUMNS.
    row = [
        0.60, 0.40,           # util_bikes, util_docks (0..1)
        -1.0, 1.0,            # delta_bikes_5m, delta_docks_5m
        -2.0, -3.0, -4.0,     # roll15_net_bikes, roll30_net_bikes, roll60_net_bikes
        12.0, 11.5, 10.9,     # roll15_bikes_mean, roll30_bikes_mean, roll60_bikes_mean
        7.2, 8.8,             # nbr_bikes_weighted, nbr_docks_weighted
        8, 2, 0, 0,           # hour, dow, is_weekend, is_holiday
        20.5, 0.0, 10.0,      # temp_c, precip_mm, wind_kph
        60.0, 1012.0,         # rhum_pct, pres_hpa
        180.0, 15.0,          # wind_dir_deg, wind_gust_kph
        0.0, 2                # snow_mm, weather_code
    ]
